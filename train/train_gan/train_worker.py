...
model_root = '/home/*/PPAN/Models'
import torch.nn as nn
from collections import OrderedDict

from PPAN.models.hd_networks import Generator
from PPAN.models.hd_networks import Discriminator
from PPAN.models.hd_networks import Vgg16
from PPAN.PPAN import train_gans
from PPAN.fuel.datasets import Dataset
...
if __name__ == '__main__':
    ...
    parser.add_argument('--maxepoch', type=int, default=800, metavar='N',
    ...
    parser.add_argument('--display_test_imgs', type=int, default=1, metavar='N',
                        help = 'save test images every {} epochs')
    parser.add_argument('--display_train_imgs', type=int, default=1000, metavar='N',
                        help='save test images every {} iterations')
    parser.add_argument('--verbose_per_iter', type=int, default=100,
    ...
    parser.add_argument('--test_sample_num', type=int, default=2,
    ...
    parser.add_argument('--G_COE', type=float, default=1.0,
                        help='the coeff of l2 loss of g output_*')
    parser.add_argument('--G_ince_COE', type=float, default=0.0000001,
                        help='the coeff of perceptual loss of g output_256')
    parser.add_argument('--D_class_COE', type=float, default=100.0,
                        help='the coeff of class loss of D/G output_256')
    ...
    if args.finest_size <= 256:
        ...
        from PPAN.models.hd_networks import GeneratorSuperL1Loss
    ...
    if args.cuda:
        ...
        vgg16 = nn.parallel.DataParallel(vgg16, device_ids=range(len(gpus)))
        vgg16 = vgg16.cuda()
        netD = netD.cuda()
        netG = netG.cuda()
    ...
    train_gans((dataset_train, dataset_test), model_root, model_name, netG, netD, vgg16, args)
